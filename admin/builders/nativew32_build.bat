...
call %SRC_DIR%\quandenser\ext\maracluster\admin\builders\_init_msvc_.bat 32bit
...
%CMAKE_EXE% -G "Visual Studio %MSVC_VER%" -DBOOST_ROOT="%PWIZ_DIR%\libraries\%BOOST_BASE%" -DZLIB_INCLUDE_DIR="%PWIZ_DIR%\libraries\%ZLIB_BASE%" -DCMAKE_PREFIX_PATH="%PWIZ_DIR%" "%SRC_DIR%\quandenser"
